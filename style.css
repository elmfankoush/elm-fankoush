...
#restartBtn{
  ...
  z-index:13;padding:12px 32px;border-radius:12px;
...
#restartBtn:hover{background:rgba(255,255,255,.18);border-color:rgba(255,255,255,.35);transform:translateX(-50%) translateY(-3px);}
.ctrl-btn{
...
.episodes-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:24px;}
...
@media(max-width:900px){
  ...
  .episodes-grid{grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:16px;}
...
@media(max-width:640px){
  ...
  /* nav — hamburger-less compact version */
